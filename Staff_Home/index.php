        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <?php
                $select1="SELECT * from customers";
                $countData=mysqli_query($connect,$select1);
                $count2=mysqli_num_rows($countData);
              ?>
                <div class="col-auto">
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <?php
                $selectPending="SELECT * from orders WHERE Order_Status='Pending.....'";
                $runData=mysqli_query($connect,$selectPending);
                $count4=mysqli_num_rows($runData);
              ?>
