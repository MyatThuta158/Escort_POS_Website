...
if (!$id) {
    ...
    if ($count > 0) {
        ...
        $phonNo = $data['Customer_PhoneNumber'];
        ...
        <div class="row justify-content-center">
            <div class="col-md-5">
                <div class="modal-content p-3 rounded">
                    ...
                    <form action="" method="POST" class="pitchTypeUpdate mt-4">
                        <table class="table">
                            <tr>
                                <td>Name</td>
                                <td><input type="text" class="form-control" name="txtName" value="<?php echo $name; ?>" readonly></td>
                            </tr>
                            <tr>
                                <td>Email</td>
                                <td><input type="text" class="form-control" name="txtemail" value="<?php echo $email; ?>" readonly></td>
                            </tr>
                            <tr>
                                <td>Phone No</td>
                                <td><input type="text" class="form-control" name="txtPhonNo" value="<?php echo $phonNo; ?>" readonly></td>
                            </tr>
                            <tr>
                                <td>Address</td>
                                <td><input type="text" name="txtPhonNo" value="<?php echo $address; ?>" class="form-control" readonly></td>
                            </tr>
                            <tr>
                                <td colspan="2" class="text-center">
                                    <?php echo "<a href='UserUpdate.php?urid=$id' class='btn btn-primary'>Update</a>"; ?>
                                </td>
                            </tr>
                        </table>
                    </form>
